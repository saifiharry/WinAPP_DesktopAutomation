...
public class ExtentListener implements ITestListener{
    ...
    public void onTestSkipped(ITestResult Result)
    {
        ...
        test.log(Status.SKIP, MarkupHelper.createLabel("Skip Test Case : " + Result.getName() ,ExtentColor.YELLOW));
    }
    ...
    public void onTestSuccess(ITestResult Result)
    {
        ...
        test = reports.createTest(Result.getName());
        test.log(Status.PASS, MarkupHelper.createLabel("Test Case : " + Result.getName() ,ExtentColor.GREEN));
    }
